...
while True:
    ...
    if key == 32:  # SPACE
        ...
        response = model.generate_content([
            "Describe the hand gesture you see in this image in less than 10 words, be detailed but concise.",
            img
        ])
...
# TODO
    # Create a new branch for the sign language aspect.
    # Once the robot is made, find out how to connect device to robot or something.
    # Consider options with the Max 78000.